...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\AdvertType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\AdvertType']) ? $this->services['AppBundle\Form\AdvertType'] : $this->services['AppBundle\Form\AdvertType'] = new \AppBundle\Form\AdvertType()) && false ?: '_'};
